...
//One of the best methods to verify an email address is to send an email to that
//email address with a unique token and ask the user to visit a certain URL on your website and enter that token.

//Data sanitisation should be also performed both on the client and server side to minimise the risk of cross scripting attacks.
...
function captureUserInput() {
  ...
  // alternative regex including thoughts about the drawbacks of using regexes:
